...
System.out.println("");
System.out.println("Groups/_ins_modules_group.jsp: ");
...
System.out.println("mod_sif: "+mod_sif);
	...
	try {
			...
			sql = "begin " + ReadDBProperties.getProperty("conn_uname")+ ".api_codes.grant_group_modul(?,?,?,?,?,?,?,?); end;";
		...
		if (errmsg != null) {
            ...
            <%
			System.out.println("Groups/_ins_modules_group.jsp: " + errmsg);
			cstmt.close();
