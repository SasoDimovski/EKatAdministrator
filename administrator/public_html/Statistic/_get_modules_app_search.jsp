...
<%
	...
	System.out.println("");
	System.out.println("Statistic/_get_modules_app_search.jsp: ");
...
<div class="box-header with-border">
	...
	<div class="box-tools pull-right"> <a
			class="btn btn-box-tool btn-xs"  data-dismiss="modal" id="get_modules_app_but"><i class="fa fa-close"></i></a>
	</div>
	<%
		}
	%>
	...
	<div class="box box-default collapsed-box box-solid" id="get_modules_app_sub<%=APL_SIF%>">
		<div class="box-header with-border">
			...
			<div class="box-tools pull-right"> <a
					...
					onClick="getModulesApp_search_stat('<%=APL_SIF%>','','get_modules_app<%=APL_SIF%>')"><i
