...
<%System.out.println("");System.out.println("Modules/ModuleList.jsp:");%>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
     ...
     <%@ include file="../_menu.jspf"%>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1><i class="fa fa-indent"></i> Привилегии</h1>
          <ol class="breadcrumb">
            <li class="active"><i class="fa fa-indent"></i>  Привилегии</li>
          </ol>
        </section>
