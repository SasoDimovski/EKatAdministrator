...
System.out.println("");
System.out.println("Users/_delete_user.jsp: ");
...
System.out.println("query: "+query);
	...
	try {
		...
		if (!"".equals(id)) {
			sql = "begin " + ReadDBProperties.getProperty("conn_uname")+ ".api_users.del_user(?,?,?); end;";
		...
		if (errmsg != null) {
            ...
            <%
			System.out.println("Users/_delete_user.jsp: " + errmsg);
			cstmt.close();
