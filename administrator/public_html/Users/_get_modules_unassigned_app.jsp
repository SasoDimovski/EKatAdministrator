...
<%
	...
	System.out.println("");
	System.out.println("Users/_get_modules_unassigned_app.jsp: ");
	...
	try {
		sql = "begin " + ReadDBProperties.getProperty("conn_uname")+ ".api_grants.get_modul_applications(?,?,?,?,?,?); end;";
...
<div class="box-header with-border">
	...
	<h5 class="box-title" title="Недоделени привилегии, апликации">
		Недоделени привилегии&nbsp;&nbsp;<span class="label label-success pull-right"><%=vkupno%></span>
	...
	<div class="box-tools pull-right">
		<a class="btn btn-success btn-xs"
			onClick="insModulesUser('<%=sif%>','','','get_modules_unassigned_app_sub','<%=prava%>')"
		...
		<div class="box-header with-border">
			...
			<div class="box-tools pull-right">
				<a class="btn btn-btn-xs"
					onClick="insModulesUser('<%=sif%>','<%=APL_SIF%>','','get_modules_unassigned_app<%=APL_SIF%>','<%=prava%>')"
