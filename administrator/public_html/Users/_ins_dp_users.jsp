...
System.out.println("");
System.out.println("Users/_ins_dp_users.jsp: ");
...
System.out.println("id_dp: "+id_dp);
    ...
    try
    {
      sql   = "begin "+ReadDBProperties.getProperty("conn_uname")+".api_work_group_admin.INS_USER_COD_DP(?,?,?,?); end;";
      ...
      errmsg= cstmt.getString(4);
		...
		if (errmsg != null) {
            ...
            <%
			System.out.println("Users/_ins_dp_users.jsp: " + errmsg);
			cstmt.close();
