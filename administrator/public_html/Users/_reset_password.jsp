...
System.out.println("");
System.out.println("Users/_reset_password.jsp: ");
...
System.out.println("query: "+query);
	...
	try {
		...
		if (!"".equals(id)) {
			sql = "begin " + ReadDBProperties.getProperty("conn_uname")+ ".api_users.reset_user_password(?,?,?); end;";
		...
		if (errmsg != null) {
            ...
            <%
			System.out.println("Users/_reset_password.jsp: " + errmsg);
			cstmt.close();
