...
System.out.println("");
System.out.println("Users/_ins_group_user.jsp: ");
...
System.out.println("all: "+all);
	...
	try {
			...
			sql = "begin " + ReadDBProperties.getProperty("conn_uname")+ ".api_grants.ins_user_groups(?,?,?,?,?); end;";
		...
		if (errmsg != null) {
            ...
            <%
			System.out.println("Users/_ins_group_user.jsp: " + errmsg);
			cstmt.close();
