...
System.out.println("");
System.out.println("Users/_del_modules_user.jsp: ");
...
System.out.println("mod_sif: "+mod_sif);
	...
	try {
			...
			sql = "begin " + ReadDBProperties.getProperty("conn_uname")+ ".api_grants.revoke_right_user_modul(?,?,?,?,?,?); end;";
		...
		if (errmsg != null) {
            ...
            <%
			System.out.println("_del_modules_user.jsp: " + errmsg);
			cstmt.close();
