...
<%
	...
	System.out.println("");
	System.out.println("Userss/_get_dp_unassigned.jsp: ");
	...
	try {
		sql = "begin " + ReadDBProperties.getProperty("conn_uname")+ ".api_work_group_admin.get_user_cod_dp_not_admin(?,?,?,?,?); end;";
...
<i class="fa fa-square"></i>
	<h3 class="box-title" title="Недоделени одделенија">
		Недоделени одделенија&nbsp;&nbsp;<span
			class="label label-default pull-right"><%=vkupno%></span>
	</h3>
	...
	<div class="box-tools pull-right">
		<a class="btn btn-default btn-xs"
			onClick="insDPUsers('<%=id%>','')"
			title="Додели ги сите недоделени одделенија"><i
...
%>
	...
	%>
		...
		<tr>
			...
			<td width="5%"><a class="btn btn-default btn-xs" title="<%=COD_DP%>"
				onClick="insDPUsers('<%=id%>','<%=COD_DP%>')"><i
