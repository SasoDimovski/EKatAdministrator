...
System.out.println("");
System.out.println("WorkGroups/_del_head_group.jsp: ");
...
System.out.println("id_user: "+id_user);
    ...
    try
    {
      sql   = "begin "+ReadDBProperties.getProperty("conn_uname")+".api_work_group_admin.del_wg_manager(?,?,?,?); end;";
     ...
     errmsg= cstmt.getString(4);
		...
		if (errmsg != null) {
            ...
            <%
			System.out.println("WorkGroups/_del_head_group.jsp: " + errmsg);
			cstmt.close();
