...
System.out.println("");
System.out.println("WorkGroups/_ins_cc_group.jsp: ");
...
System.out.println("cod_cc: "+cod_cc);
    ...
    try
    {
      sql   = "begin "+ReadDBProperties.getProperty("conn_uname")+".api_work_group_admin.ins_wg_cod_cc_admin(?,?,?,?,?); end;";
      ...
      errmsg= cstmt.getString(5);
		...
		if (errmsg != null) {
            ...
            <%
			System.out.println("WorkGroups/_ins_cc_group.jsp: " + errmsg);
			cstmt.close();
