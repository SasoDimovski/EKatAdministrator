...
System.out.println("");
System.out.println("WorkGroups/_delete_workgroup.jsp: ");
...
System.out.println("query: "+query);
	...
	try {
		...
		if (!"".equals(id)) {
			sql = "begin " + ReadDBProperties.getProperty("conn_uname")+ ".api_work_group_admin.del_work_groups(?,?,?); end;";
		...
		if (errmsg != null) {
            ...
            <%
			System.out.println("WorkGroups/_delete_workgroup.jsp: " + errmsg);
			cstmt.close();
