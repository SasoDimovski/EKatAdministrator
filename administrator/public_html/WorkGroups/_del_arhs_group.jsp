...
System.out.println("");
System.out.println("WorkGroups/_del_arhs_group.jsp: ");
...
System.out.println("arh_sign: "+arh_sign);
    ...
    try
    {
      sql   = "begin "+ReadDBProperties.getProperty("conn_uname")+".api_work_group_admin.del_wg_arhsign(?,?,?,?); end;";
     ...
     errmsg= cstmt.getString(4);
		...
		if (errmsg != null) {
            ...
            <%
			System.out.println("WorkGroups/_del_arhs_group.jsp: " + errmsg);
			cstmt.close();
