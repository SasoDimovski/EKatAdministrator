...
System.out.println("");
System.out.println("WorkGroups/_ins_arhs_group.jsp: ");

String id = request.getParameter("id");if (id==null){id="";}
String arh_sign = request.getParameter("arh_sign");if (arh_sign==null){arh_sign="";}

System.out.println("id: "+id);
System.out.println("arh_sign: "+arh_sign);
    ...
    try
    {
      sql   = "begin "+ReadDBProperties.getProperty("conn_uname")+".api_work_group_admin.ins_wg_arhsign_admin(?,?,?,?); end;";
      conn  = DBConnection.getConnection(session);
      
      cstmt = conn.prepareCall(sql);
      
      cstmt.setString(1,id);   
      cstmt.setString(2,arh_sign); 
      ...
      errmsg= cstmt.getString(4);
		...
		if (errmsg != null) {
            ...
            <%
			System.out.println("WorkGroups/_ins_arhs_group.jsp: " + errmsg);
			cstmt.close();
